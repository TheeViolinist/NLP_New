...
nome_similaridade_arquivo = str(input("Digite o nome de arquivo de similaridade: "))
nome_instance = str(input("Digite o nome do arquivo de instancia: "))
nome_instance_dic = str(input("Digite o nome de arquivo de dicionario: "))
nome_instance_similarity = str(input("Digite o nome do arquivo de similaridade a ser criado: "))
...
for author in similarity_data_list:
    ...
    if posicao_author_1 != -1:
        ...
        while name_author == similarities[posicao_author_1]["autor 1"]: 
